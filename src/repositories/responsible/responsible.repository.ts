...
@Injectable()
export class ResponsibleRepository extends Pageable<Responsible> implements IResponsibleRepository {
  constructor(
  ...
  async findAll(page: Page, filters: FiltersResponsibleDTO): Promise<PageResponse<Responsible>> {
